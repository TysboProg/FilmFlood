        ...
        <>
            <div className="mx-auto max-w-md p-6 rounded-lg bg-[#1E1F25] text-white">
                <div className="mb-8 text-center">
                    <h1 className="mb-2 text-3xl font-bold text-white">С возврщаением!</h1>
                    <p className="text-gray-400">Авторизируйся на сайте FilmFLOOD снова!</p>
                </div>
                ...
                <div className="mt-4 text-center text-sm text-gray-400">
                    У вас нету аккаунта?{" "}
                    <a href="/login" className="text-[#E53E3E] hover:underline">
                        Зарегистрируйся
                    </a>
                </div>
            </div>
