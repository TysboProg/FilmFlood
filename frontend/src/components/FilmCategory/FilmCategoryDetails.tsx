                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-5">
                            {films.map((film, index) => (
                                <Link
                                    ...
                                    href={`/film/${encodeURIComponent(film.filmName)}`}
                                    className="group"
                                >
                                    <Card className="bg-[#1a1a28]/80 border-[#3a3a5a]/30 overflow-hidden h-full transition-all duration-300 hover:border-[#3a3a5a] hover:shadow-xl hover:shadow-black/20 rounded-xl">
                                        <div className="relative aspect-[2/3] overflow-hidden rounded-t-lg">
                                            <Image
                                                src={film.posterUrl || "/placeholder.svg?height=300&width=200"}
                                            ...
                                            {/* Rating badge */}
                                            {film.rating && Number.parseFloat(film.rating) > 0 && (
                                        ...
                                        <CardFooter className="p-3 flex flex-col items-start">
                                            <h3 className="text-sm font-medium truncate w-full group-hover:text-red-500 transition-colors">
                                                {film.filmName || "Untitled"}
                                            </h3>
                                            <div className="flex items-center gap-2 mt-1 w-full">
                                                {film.yearProd && (
                                                    <p className="text-xs text-gray-400 bg-[#252536] px-2 py-0.5 rounded-md">{film.yearProd}</p>
                                                )}
                                                {film.genre_name && <p className="text-xs text-gray-400 truncate ml-auto">{film.genre_name}</p>}
                                            </div>
                                        </CardFooter>
                                    </Card>
                                </Link>
